...
define('APP_BASE_URL', 'https://crm.ecogo.ai/');

/* * -------------------------------------------------------------------------- * Encryption Key * IMPORTANT: Do not change this ever! * -------------------------------------------------------------------------- * * If you use the Encryption class, you must set an encryption key. * See the user guide for more info. * * http://codeigniter.com/user_guide/libraries/encryption.html * * Auto added on install */
define('APP_ENC_KEY', '212e5d9fa9707f94b9a1b0636747bd1b');
 ...
 */
define('APP_DB_USERNAME', getenv('APP_DB_USERNAME') ?: 'u774665502_crm_ecogo');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', getenv('APP_DB_PASSWORD') ?: 'KldkhhmS392');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', getenv('APP_DB_NAME') ?: 'u774665502_crm_ecogo');
